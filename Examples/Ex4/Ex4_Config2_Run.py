...
if True:
    ...
    Road_data=os.getcwd()+'/Exogenous_Inputs/' + 'Road_data'
    ...
    optimal_control_file=os.getcwd()+'/Exogenous_Inputs/'+'optimal_control'
    ...
    GPOPS_Result=loadmat(os.getcwd()+'/Exogenous_Inputs/'+"optimal_control.mat")
